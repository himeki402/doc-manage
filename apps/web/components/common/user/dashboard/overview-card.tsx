...
import { DocumentStatsResponseDto } from "@/lib/types/document";
...
export default function OverviewCards({ documentsStats }: OverviewCardsProps) {
    const overviewData = [
        {
            title: "Tổng tài liệu",
            value: documentsStats?.data.totalDocuments || 0,
